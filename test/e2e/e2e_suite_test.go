...
var (
	...
	projectImage = "ashutoshbrl/zoperator:v1alpha1.0.36"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting lab integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	_, err = utils.Run(cmd)
	ExpectWithOffset(1, err).NotTo(HaveOccurred(), "Failed to install manifests")
